  ...
  return (
    <div className="d-flex flex-column vh-100 sidebar">
      ...
      <div className="my-auto">
        <NavLink to="/user/tickets" className="btn btn-light w-100 mb-3" activeClassName="active-link">
          <i className="fas fa-ticket-alt"></i> My Tickets
        </NavLink>
        <NavLink to="/user/submit" className="btn btn-light w-100 mb-3" activeClassName="active-link">
          <i className="fas fa-plus"></i> Submit a ticket
        </NavLink>
        <NavLink to="/user/mails" className="btn btn-light w-100 mb-3" activeClassName="active-link">
